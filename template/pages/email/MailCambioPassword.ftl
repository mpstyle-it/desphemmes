            ...
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <meta name="viewport" content="width=device-width, initial-scale=1">
                    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet">
                        <title>${emailLabelMap.PasswordChangeTitle}</title>
                        ...
                        <style type="text/css">
                            ...
                            */
                            #templateUpperBody .mcnTextContent,#templateUpperBody .mcnTextContent p{
                                /*@editable*/color:#666666;
                                /*@editable*/font-family:"Montserrat",Arial,sans-serif;
                                /*@editable*/font-size:12px;
                                /*@editable*/line-height:150%;
                                /*@editable*/text-align:left;
                                letter-spacing:0.5px;
                            ...
                            */
                            #templateFooter{
                                ...
                                /*@editable*/background-position:center;
                                /*@editable*/background-size:cover;
                                /*@editable*/border-top:3px solid #000;
                                /*@editable*/border-bottom:0;
                                    ...
                                    <tr>
                                        <td align="center" valign="top" id="bodyCell">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                                                ...
                                                <tr>
                                                    <td valign="top" id="templateHeader"><table class="mcnDividerBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                ...
                                                <tr>
                                                    <td valign="top" id="templateUpperBody"><table class="mcnDividerBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody class="mcnDividerBlockOuter">
                                                                <tr>
                                                                        ...
                                                                        <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                            <tbody><tr>
                                                                                    <td class="mcnTextContent" style="padding: 0px 18px 40px 40px; font-family: &quot;Montserrat&quot;, Arial, sans-serif; font-size: 12px; text-align: left;" valign="top">
                                                                                        ...
                                                                                        <h1 style="text-align:center;"> ${emailLabelMap.PasswordChangeTitle}</h1>

                                                                                        <p>${emailLabelMap.PasswordChangeText}</p>
                                                                                        <br>
                                                                                        <p>${password}</p>
                                                                                        <br>
                                                                                    ...
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                                        ...
                                                                                        <div class="ax_paragraph" id="u18">
                                                                                            <div class="text" id="u19">
                                                                                                <p><span>Olmar and Mirta spa - P.IVA 01817070202</span><br>
                                                                                                        <span>Via Cocapana, 9 - 46026 Quistello (MN) - Italy</span></p>
                                                                                                </div>
                                                                                            </div>
