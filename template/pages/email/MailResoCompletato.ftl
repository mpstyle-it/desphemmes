                ...
                <td align="center" valign="top" id="bodyCell">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                        ...
                        <tr>
                          ...
                          <!-- @giulio ##################################### ORDER GENERAL INFO - from ReturnHeader ##################################### -->
                                                <#assign fullDate = returnHeader.entryDate.toString() />
                                                <#assign returnEntryDate = fullDate?keep_before_last(" ") />
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="mcnTextContent" style="padding: 0px 18px 9px; font-family: &quot;Montserrat&quot;, Arial, sans-serif; font-size: 12px; text-align: center;" valign="top">
                                                                <h1>${emailLabelMap.ReturnCompletedTitle}</h1> <#-- @giulio LABEL -->
                                                                <p style="font-family: &quot;Montserrat&quot;, Arial, sans-serif; font-size: 12px; text-align: center;">${emailLabelMap.RequestReturnNumber} <strong>${returnHeader.returnId?if_exists}</strong> ${emailLabelMap.OrderConfirmationOrderOf} <strong>${returnEntryDate?if_exists}</strong>
                                                                </p>
                                                                <div class="text" id="u5">
                                                                    ...
                                                                    <p style="font-family: &quot;Montserrat&quot;, Arial, sans-serif; font-size: 12px; text-align: center;">
                                                                      <span>${emailLabelMap.ModaCodeAvailable} <strong>#${modaCodeId}</strong>, ${emailLabelMap.ModaCodeAmount} <strong><@ofbizCurrency amount=modaCodeAmount isoCode=currencyUomId /></strong></span>
                                                                    </p>
                                                                  -->
                                                                </div>
                                                            </td>
                        ...
                        <!-- @giulio ##################################### END ORDER GENERAL INFO - from ReturnHeader ##################################### -->
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                                ...
                                                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="mcnTextContent" style="padding: 0px 18px 9px; font-family: &quot;Montserrat&quot;, Arial, sans-serif; font-size: 12px; text-align: center;" valign="top">
                                                                <!-- @giulio ########### LABEL "YOUR RETURN" ########### -->
                                                                <h1>${emailLabelMap.RetailReturnYourItems}</h1>
                                ...
                                <#-- @giulio ############################## START LISTING RETURN ITEMS ############################## -->
                                <#list returnItems as returnItem>
                                  <#assign productRelated = returnItem.getRelatedOne("Product", true)?if_exists /> <#-- should always exist because of FK constraint, but just in case -->
                                                                      ...
                                                                      <tbody>
                                                                          <tr>
                                                                              <td class="mcnTextContent" style="line-height: 200%; text-align: right;" valign="top">
                                                                                  <span>${returnItem.description?default("")} - ${product.comments?if_exists} - ${itemSize?if_exists}:&nbsp; <strong><@ofbizCurrency amount=returnItem.returnPrice isoCode=currencyUomId /></strong></span>
                                                                              </td>
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
